...
module.exports = {
  ...
  start: async (A17, m, { inputCMD, text, doReact, prefix, pushName }) => {
    switch (inputCMD) {
      case "play":
      case "song":
        if (!text) {
        ...
        await doReact("📥");
        thumbA17 = "https://cdn.donmai.us/sample/b2/77/__sensei_and_plana_blue_archive_drawn_by_fpanda__sample-b277ea432a04ccedd806a4d64bcb329e.jpg";
...
_🏮 Video Uploaded:_ *${song.ago}*\n`,
        ...
        YT.mp3(videoId).then((file) => {
          ...
          ffmpeg(inputPath)
            ...
            .on("end", async () => {
              ...
              const thumbnailBuffer = await getBuffer(thumbArashi);

              await A17.sendPresenceUpdate("recording", m.from);
      ...
      case "ytaudio":
        ...
        videoUrl = song.url;
        videoId = videoUrl.split("v=")[1];
        thumbArashi = "https://cdn.donmai.us/sample/b2/77/__sensei_and_plana_blue_archive_drawn_by_fpanda__sample-b277ea432a04ccedd806a4d64bcb329e.jpg";
        ...
        YT.mp3(videoId).then((file) => {
          ...
          ffmpeg(inputPath)
            ...
            .on("end", async () => {
              ...
              await Arashi.sendPresenceUpdate("recording", m.from);
...
_🏮 Video Uploaded:_ *${song.ago}*\n`,
      ...
      case "ytsearch":
        ...
        Arashi.sendMessage(m.from, buttonMessage, { quoted: m });
        break;
