...
I NEED THAT HERTUSSY 💦🍆`,
   ...
   if (smallinput.includes('وينو')) {
    ...
    reply (`زلطه ؟ قصدك الحلبي الصبجه البلعب طيزعين فريم وبلع بوكسات من هندي`);
  }
    ...
    reply (`عبد الله؟ قصدك عب قنشن السمين داك؟ `);
    }
  ...
  Type *surrender* to surrender and admit defeat...`
      ...
      */
      ...
      case 'gpt': {
        ...
        try {
          const apiUrl1 = `https://vihangayt.me/tools/chatgptv4?q=${encodeURIComponent(q)}`;
